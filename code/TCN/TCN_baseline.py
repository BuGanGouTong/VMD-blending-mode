...
net = TCNmodel(layer_num=layer_num, n_input=feature, n_filter=128, kernel_size=3, dropout_rate=dropout_rate, seq_len=window_length)
...
#                'TCN_window_{}+LR_{}+layer_{}+drop_{}+MAPE_{}.pkl'.format(
